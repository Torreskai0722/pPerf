...
for output_dir in output_dirs:
    ...
    model_names = ['deeplabv3+_r50-d8_512x1024_40k_sem_seg_bdd100k', 'centerpoint_voxel0075_second_secfpn_head-dcn-circlenms_8xb4-cyclic-20e_nus-3d']
    ...
    for model_name in model_names:
        for scene in scenes:
            layer_processor.plot_layer_boxplot(
                ...
                save_plot=True,
                scene=scene,
                seg_model=model_names[0],
                lidar_model=model_names[1],
            )
