...
# output_dirs = ['full_stack_1I1L1S-MPS']
...
#         )
    # model_names = ['yolov3_d53_mstrain-608_273e_coco', 'deeplabv3+_r50-d8_512x1024_40k_sem_seg_bdd100k', 'centerpoint_voxel0075_second_secfpn_head-dcn-circlenms_8xb4-cyclic-20e_nus-3d']
    # # model_names = ['detr_r50_8xb2-150e_coco', 'deeplabv3+_r50-d8_512x1024_40k_sem_seg_bdd100k', 'centerpoint_voxel0075_second_secfpn_head-dcn-circlenms_8xb4-cyclic-20e_nus-3d']
    # layer_name = 'inference'

    # for model_name in model_names:
    #     layer_processor.plot_layer_boxplot(
    #         run_indices=[9, 10, 11, 12, 13, 14, 15, 16, 17],
    #         mapping_file=mapping_file,
    #         metric='seg_mps_percentage',
