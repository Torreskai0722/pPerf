...
depths = [0]
image_model = 'faster-rcnn_r50_fpn_1x_coco'  # Only this model
...
# Repeat each combo 10 times
combinations = []
for rep in range(10):
    for combo in product(image_sample_freqs, lidar_sample_freqs, depths, lidar_models):
        combinations.append((combo[0], combo[1], combo[2], image_model, combo[3]))
